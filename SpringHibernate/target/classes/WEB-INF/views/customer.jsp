  ...
  .error {
      ...
      font-style: italic;
       ...
       function deleteCustomer(customerId){
    	   if(confirm('do u want to delete this custome?')){
...
<spring:message code="label.customerId"></spring:message></form:label>
</td>
<td>
...
<spring:message code="label.customername"/></form:label>
</td>
<td>
...
<spring:message code="label.address"/></form:label>
</td>
<td>
...
<spring:message code="label.age"/></form:label>
</td>
<td>
...
<spring:message code="label.salary"/></form:label>
</td>
<td>
...
<input type="submit" value="<spring:message code="label.editcustomer"/>"/></c:if>
<c:if test="${empty customer.name}">
<input type="submit" value="<spring:message code="label.addcustomer"/>"/></c:if>
</td>
</tr></table></form:form>
